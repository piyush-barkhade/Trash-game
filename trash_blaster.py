...
class JohnGreenBot:
    def __init__(self, game):
        ...
        """
        self.john_green_bot_img = pygame.image.load('./assets/john_green_bot2.png')
...
class Background:
    def __init__(self, game):
        ...
        """
        self.game = game
        self.background_img = pygame.image.load('./assets/background1.png')
...
class Trash:
  def __init__(self, game, position:pygame.Vector2, moveDirection:pygame.Vector2, size):
    ...
    it random speed.
    """
    self.trash_img = pygame.image.load('./assets/trash1.png')
    self.game = game
    self.size = size
    self.position = position
    self.rotation = 0.0
